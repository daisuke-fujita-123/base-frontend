...
/** SCR-COM-0014-0001: 手数料表示API リクエスト */
...
/** SCR-COM-0014-0001: 手数料表示API レスポンス */
...
/** SCR-COM-0014-0001: 手数料表示API 条件設定セクションレスポンス(リスト行) */
...
/** SCR-COM-0014-0001: 手数料表示API 価格設定セクションレスポンス(リスト行) */
...
/** SCR-COM-0014-0003: 手数料テーブル詳細入力チェックAPI リクエスト */
...
/** SCR-COM-0014-0003: 手数料テーブル詳細入力チェックAPI レスポンス */
export interface ScrCom0014CommissionCheckResponse {
    /** エラー内容リスト */
    errorList: errorList[];
}


/** SCR-COM-0014-0003: 手数料テーブル詳細入力チェックAPI レスポンス(リスト行) */
...
/** SCR-COM-0014-0007: 手数料テーブル登録申請API リクエスト */
...
/** SCR-COM-0014-0007: 手数料テーブル登録申請API リクエスト(リスト行) */
...
export const ScrCom0014GetCommissionDisplay = async (
    ...
    const response = await comApiClient.post(
        '/scr-com-0014/get-commission-display-current-info',
        request
    );
...
): Promise<ScrCom0014CommissionCheckResponse> => {
    const response = await comApiClient.post(
        '/scr-com-0014/commission-check',
        request
    );
    return response.data;
};
...
export const ScrCom0014ApplyRegistrationCommissionInfo = async (
    ...
    const response = await comApiClient.post(
        '/scr-com-0014/apply-registration-commission-info',
        request
    );
    return response.data;
};
