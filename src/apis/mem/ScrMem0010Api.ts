...
/** API-MEM-0010-0002: 事業拠点基本情報取得API */
...
/** API-MEM-0010-0005: 事業拠点基本情報入力チェックAPI */
export const ScrMem0010InputCheckBusinessBase = async (
  ...
  const response = await memApiClient.post(
    '/api/mem/scr-mem-0010/input-check-business-base',
    request
  );
  return response.data;
};
