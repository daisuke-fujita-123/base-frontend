...
export const fieldValidationDefinition: Definition = {
  reportComment1: yup.string().label('帳票コメント(1行目)').max(9801).fullAndHalfWidth(),
  reportComment2: yup.string().label('帳票コメント(2行目)').max(9801).fullAndHalfWidth(),
  reportComment3: yup.string().label('帳票コメント(3行目)').max(9801).fullAndHalfWidth(),
  reportComment4: yup.string().label('帳票コメント(4行目)').max(9801).fullAndHalfWidth(),
};
